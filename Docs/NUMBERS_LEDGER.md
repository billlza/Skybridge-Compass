...
```
Artifacts/system_impact_2026-01-23.csv → session-level connect/transfer metrics (generated by a separate benchmark suite; pinned via \artifactdateSystemImpact)
```
