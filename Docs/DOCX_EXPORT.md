...
- **Cross-references aligned** (including Supplementary labels via `TDSC-2026-01-0318_supplementary.aux`)
...
- `TDSC-2026-01-0318_IEEE_Paper_SkyBridge_Compass_patched.docx` (overwritten)
- A timestamped backup: `TDSC-2026-01-0318_IEEE_Paper_SkyBridge_Compass_patched_BACKUP_YYYYMMDD_HHMMSS.docx`
