...
\midrule
Provider Protocol & {\scriptsize\texttt{Sources/SkyBridgeCore/P2P/CryptoProviderProtocol.swift}} (L24--113) \\
Handshake Types & {\scriptsize\texttt{Sources/SkyBridgeCore/P2P/HandshakeTypes.swift}} (L297--320) \\
Provider Factory & {\scriptsize\texttt{Sources/SkyBridgeCore/P2P/CryptoProviderFactory.swift}} (L18--179) \\
Handshake Driver & {\scriptsize\texttt{Sources/SkyBridgeCore/P2P/HandshakeDriver.swift}} (L258--338, L1042--1145) \\
Handshake Context & {\scriptsize\texttt{Sources/SkyBridgeCore/P2P/HandshakeContext.swift}} (L27--100, L862--933) \\
Secure Bytes & {\scriptsize\texttt{Sources/SkyBridgeCore/P2P/SecureBytes.swift}} (L25--99) \\
Message Signatures & {\scriptsize\texttt{Sources/SkyBridgeCore/P2P/HandshakeMessages.swift}} (L557--569, L801--821) \\
Apple PQC Provider & {\scriptsize\texttt{Sources/SkyBridgeCore/P2P/Providers/ApplePQCProvider.swift}} (L27--152) \\
Security Events & {\scriptsize\texttt{Sources/SkyBridgeCore/Security/SecurityEventEmitter.swift}} (L22--136) \\
SE Signing & {\scriptsize\texttt{Sources/SkyBridgeCore/P2P/SecureEnclaveSigningCallback.swift}} (L40--94) \\
Signature Selector & {\scriptsize\texttt{Sources/SkyBridgeCore/P2P/PreNegotiationSignatureSelector.swift}} (L69--96) \\
Route-Aware Discovery & {\scriptsize\texttt{Sources/SkyBridgeCore/P2P/P2PDiscoveryService.swift}} (L278--457) \\
Connection State Guarding & {\scriptsize\texttt{Sources/SkyBridgeCore/DeviceDiscovery/UnifiedOnlineDeviceManager.swift}} (L940--989) \\
Active Transfer Route Selection & {\scriptsize\texttt{Sources/SkyBridgeCore/FileTransfer/FileTransferManager.swift}} (L104--213) \\
\bottomrule
\end{tabular}
\end{table}
