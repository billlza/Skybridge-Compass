...
machine ensures evidence corresponds to the actual decision path, and we
validate this end-to-end under fault injection and active suppression.
...
\item
  ...
  FS semantics. v1 favors bridge compatibility with paired long-term KEM
  identity keys; v2 is available as an incremental upgrade and is
  evaluated in Supplementary Table~\ref{tab:supp-v2-v1-compare}.
\item
