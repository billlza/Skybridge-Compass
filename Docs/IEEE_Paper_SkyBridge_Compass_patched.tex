...
classic/\allowbreak liboqs/\allowbreak CryptoKit, remaining below
...
sketches tied to protocol mechanics. Formal verification using model checking or symbolic analysis \cite{ref29} is planned for future work:
