...
\newcommand{\artifactzipsha}{354443f7\allowbreak{}cda3e25a\allowbreak{}51480a68\allowbreak{}3da1712a\allowbreak{}8ea9588a\allowbreak{}2bc510f4\allowbreak{}f716bd55\allowbreak{}3d6d72ac}
\newcommand{\artifacttarurl}{\artifacturl/archive/refs/tags/\artifacttag.tar.gz}
\newcommand{\artifacttarsha}{90228458\allowbreak{}587f095e\allowbreak{}9cd403d3\allowbreak{}d449f885\allowbreak{}a2b8b002\allowbreak{}057a76e6\allowbreak{}f60c291e\allowbreak{}45071388}
...
\author{Zi'ang Li\\Independent Researcher, Tianjin, China\\E-mail: 2403871950@qq.com}
\maketitle
...
\item Tables~\ref{tab:supp-repeatability-latency}--\ref{tab:supp-repeatability-rtt} (Repeatability): Supports Section~\ref{sec:evaluation} (multi-batch confidence intervals)
...
\begin{itemize}
\item Classic: $354 + 397 + 2 \times 38 = 827$~B
\item liboqs PQC: $6577 + 5510 + 2 \times 38 = 12{,}163$~B
\item CryptoKit PQC: $6577 + 5510 + 2 \times 38 = 12{,}163$~B
\item X-Wing (CryptoKit): $6609 + 5510 + 2 \times 38 = 12{,}195$~B
\end{itemize}
...
These files can be regenerated using \texttt{Scripts/\allowbreak run\_\allowbreak paper\_\allowbreak eval.sh} from the artifact repository; \texttt{Scripts/\allowbreak make\_\allowbreak tables.py} selects the latest matching CSV by prefix.
...
\end{itemize}
All CSV outputs are date-stamped under \texttt{Artifacts/}.
