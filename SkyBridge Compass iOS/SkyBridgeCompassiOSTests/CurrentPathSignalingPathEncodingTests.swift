...
private typealias SignalingPolicy = CurrentPathSignalingWebSocketPolicyCompat
...
final class CurrentPathSignalingPathEncodingTests: XCTestCase {
    ...
    private func assertRejected(_ path: String?, file: StaticString = #filePath, line: UInt = #line) {
        XCTAssertNil(SignalingPolicy.validatedWebSocketPath(path), file: file, line: line)
