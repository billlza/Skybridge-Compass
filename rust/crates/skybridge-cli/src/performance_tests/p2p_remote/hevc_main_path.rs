...
fn p2p_remote_hevc_main_path_requires_bounded_sck_cadence() {
    ...
    for line in [
        ...
        "mac-sck-encoder targetFPS=60 codec=hevc cadenceCatchUpLimit=2 maxFrameDelayCount=3 maximumRealTimeFrameRate=120 dataRateLimitBytesPerSecond=2000000 dataRateBurstLimitBytes=262044 dataRateBurstWindowMs=17 singleChunkHEVCBudgetBytes=262044 dataRateLimitsStatus=0 dataRateLimitsReadbackStatus=0 dataRateLimitsApplied=1 dataRateReadbackBurstLimitBytes=262044 dataRateReadbackBurstWindowMs=17 lowLatency=true lowLatencyRateControl=false capturesAudio=false",
    ...
    let mut fresh_source_with_sparse_callbacks = P2pRemotePerformanceEvidence::default();
    for line in [
        "mac-stream-config codec=hevc fps=60 fallback=fail-fast",
        "mac-sck-first-frame codec=hevc verifiedSync=true",
        "mac-sck-encoder targetFPS=60 codec=hevc cadenceCatchUpLimit=2 maxFrameDelayCount=3 maximumRealTimeFrameRate=120 dataRateLimitBytesPerSecond=2000000 dataRateBurstLimitBytes=262044 dataRateBurstWindowMs=17 singleChunkHEVCBudgetBytes=262044 dataRateLimitsStatus=0 dataRateLimitsReadbackStatus=0 dataRateLimitsApplied=1 dataRateReadbackBurstLimitBytes=262044 dataRateReadbackBurstWindowMs=17 lowLatency=true lowLatencyRateControl=false capturesAudio=false",
        ...
        update_p2p_remote_evidence(&mut fresh_source_with_sparse_callbacks, line, true, false);
    }
    let check = check_p2p_remote_hevc_main_path(&fresh_source_with_sparse_callbacks);
    assert!(check.ok, "{}", check.detail);
    ...
    for line in [
        "mac-stream-config codec=hevc fps=60 fallback=fail-fast",
        "mac-sck-first-frame codec=hevc verifiedSync=true",
        "mac-sck-encoder targetFPS=60 codec=hevc cadenceCatchUpLimit=2 maxFrameDelayCount=3 maximumRealTimeFrameRate=120 dataRateLimitBytesPerSecond=2000000 dataRateBurstLimitBytes=262044 dataRateBurstWindowMs=17 singleChunkHEVCBudgetBytes=262044 dataRateLimitsStatus=0 dataRateLimitsReadbackStatus=0 dataRateLimitsApplied=1 dataRateReadbackBurstLimitBytes=262044 dataRateReadbackBurstWindowMs=17 lowLatency=true lowLatencyRateControl=true capturesAudio=false",
    ...
    for line in [
        "mac-stream-config codec=hevc fps=60 fallback=fail-fast",
        "mac-sck-first-frame codec=hevc verifiedSync=true",
        "mac-sck-encoder targetFPS=60 codec=hevc cadenceCatchUpLimit=2 maxFrameDelayCount=3 maximumRealTimeFrameRate=120 dataRateLimitBytesPerSecond=2000000 dataRateBurstLimitBytes=262044 dataRateBurstWindowMs=17 singleChunkHEVCBudgetBytes=262044 dataRateLimitsStatus=0 dataRateLimitsReadbackStatus=0 dataRateLimitsApplied=1 dataRateReadbackBurstLimitBytes=262044 dataRateReadbackBurstWindowMs=17 lowLatency=true capturesAudio=false",
        "mac-sck-tx targetFPS=60 codec=hevc capturesAudio=false captureFPS=60.0 meaningfulFPS=60.0 captured=60 meaningful=60 sourceFrameRepeatMax=1 sourceFrameAgeMaxMs=16.7 encodedFPS=60.0 encodeFailures=0 cadenceTimerFires=120 cadenceSubmitted=60 cadenceCatchUpFrames=1 cadenceBatchMax=2",
    ] {
    ...
    for line in [
        "mac-stream-config codec=hevc fps=60 fallback=fail-fast",
        "mac-sck-first-frame codec=hevc verifiedSync=true",
        "mac-sck-encoder targetFPS=60 codec=hevc cadenceCatchUpLimit=2 maxFrameDelayCount=1 maximumRealTimeFrameRate=120 dataRateLimitBytesPerSecond=2000000 dataRateBurstLimitBytes=262044 dataRateBurstWindowMs=17 singleChunkHEVCBudgetBytes=262044 dataRateLimitsStatus=0 dataRateLimitsReadbackStatus=0 dataRateLimitsApplied=1 dataRateReadbackBurstLimitBytes=262044 dataRateReadbackBurstWindowMs=17 lowLatency=true lowLatencyRateControl=true capturesAudio=false",
    ...
    for line in [
        "mac-stream-config codec=hevc fps=60 fallback=fail-fast",
        "mac-sck-first-frame codec=hevc verifiedSync=true",
        "mac-sck-encoder targetFPS=60 codec=hevc cadenceCatchUpLimit=4 maxFrameDelayCount=3 maximumRealTimeFrameRate=120 dataRateLimitBytesPerSecond=2000000 dataRateBurstLimitBytes=262044 dataRateBurstWindowMs=17 singleChunkHEVCBudgetBytes=262044 dataRateLimitsStatus=0 dataRateLimitsReadbackStatus=0 dataRateLimitsApplied=1 dataRateReadbackBurstLimitBytes=262044 dataRateReadbackBurstWindowMs=17 lowLatency=true lowLatencyRateControl=true capturesAudio=false",
    ...
    for line in [
        "mac-stream-config codec=hevc fps=60 fallback=fail-fast",
        "mac-sck-first-frame codec=hevc verifiedSync=true",
        "mac-sck-encoder targetFPS=60 codec=hevc cadenceCatchUpLimit=2 maxFrameDelayCount=3 maximumRealTimeFrameRate=120 dataRateLimitBytesPerSecond=2000000 dataRateBurstLimitBytes=1500000 dataRateBurstWindowMs=17 singleChunkHEVCBudgetBytes=262044 dataRateLimitsStatus=0 dataRateLimitsReadbackStatus=0 dataRateLimitsApplied=1 dataRateReadbackBurstLimitBytes=1500000 dataRateReadbackBurstWindowMs=17 lowLatency=true lowLatencyRateControl=true capturesAudio=false",
        "mac-sck-tx targetFPS=60 codec=hevc capturesAudio=false captureFPS=60.0 meaningfulFPS=60.0 captured=60 meaningful=60 sourceFrameRepeatMax=1 sourceFrameAgeMaxMs=16.7 encodedFPS=60.0 encodeFailures=0 cadenceTimerFires=120 cadenceSubmitted=60 cadenceCatchUpFrames=0 cadenceBatchMax=1",
    ] {
    ...
    for line in [
        "mac-stream-config codec=hevc fps=60 fallback=fail-fast",
        "mac-sck-first-frame codec=hevc verifiedSync=true",
        "mac-sck-encoder targetFPS=60 codec=hevc cadenceCatchUpLimit=2 maxFrameDelayCount=3 maximumRealTimeFrameRate=120 dataRateLimitBytesPerSecond=2000000 dataRateBurstLimitBytes=262044 dataRateBurstWindowMs=17 singleChunkHEVCBudgetBytes=262044 dataRateLimitsStatus=-12900 dataRateLimitsReadbackStatus=0 dataRateLimitsApplied=0 dataRateReadbackBurstLimitBytes=262044 dataRateReadbackBurstWindowMs=17 lowLatency=true lowLatencyRateControl=true capturesAudio=false",
        "mac-sck-tx targetFPS=60 codec=hevc capturesAudio=false captureFPS=60.0 meaningfulFPS=60.0 captured=60 meaningful=60 sourceFrameRepeatMax=1 sourceFrameAgeMaxMs=16.7 encodedFPS=60.0 encodeFailures=0 cadenceTimerFires=120 cadenceSubmitted=60 cadenceCatchUpFrames=0 cadenceBatchMax=1",
    ] {
    ...
    for line in [
        ...
        "mac-sck-first-frame codec=hevc verifiedSync=true",
        "mac-sck-encoder targetFPS=60 codec=hevc cadenceCatchUpLimit=2 maxFrameDelayCount=3 maximumRealTimeFrameRate=120 dataRateLimitBytesPerSecond=2000000 dataRateBurstLimitBytes=262044 dataRateBurstWindowMs=17 singleChunkHEVCBudgetBytes=262044 dataRateLimitsStatus=0 dataRateLimitsReadbackStatus=0 dataRateLimitsApplied=1 dataRateReadbackBurstLimitBytes=262044 dataRateReadbackBurstWindowMs=17 lowLatency=true lowLatencyRateControl=true capturesAudio=false",
        "mac-sck-tx targetFPS=60 codec=hevc capturesAudio=false captureFPS=60.0 meaningfulFPS=60.0 captured=60 meaningful=60 sourceFrameRepeatMax=1 sourceFrameAgeMaxMs=16.7 encodedFPS=60.0 encodeFailures=0 encodedFrameBytesMax=300000 encodedSyncFrameBytesMax=300000 singleChunkHEVCBudgetBytes=262044 oversizedEncodedFrames=1 oversizedSyncFrames=1 cadenceTimerFires=120 cadenceSubmitted=60 cadenceCatchUpFrames=0 cadenceBatchMax=1",
    ] {
