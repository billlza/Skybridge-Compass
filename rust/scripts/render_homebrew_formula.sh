...
: "${SKYBRIDGE_LINUX_ARM64_SHA256:?set SKYBRIDGE_LINUX_ARM64_SHA256}"
: "${SKYBRIDGE_LINUX_X64_SHA256:?set SKYBRIDGE_LINUX_X64_SHA256}"
...
sed \
  ...
  -e "s|__LINUX_ARM64_SHA256__|${SKYBRIDGE_LINUX_ARM64_SHA256}|g" \
  -e "s|__LINUX_X64_SHA256__|${SKYBRIDGE_LINUX_X64_SHA256}|g" \
