...
final class AppUpdateManifestTests: XCTestCase {
    ...
    func testAppUpdateCheckerUsesTrustedSignedGitHubManifestContract() throws {
        ...
        XCTAssertTrue(evidenceWorkflow.contains("Require Single-Maintainer Evidence Approval Environment"))
        XCTAssertTrue(evidenceWorkflow.contains("validate_release_environment_protection.py"))
        XCTAssertEqual(evidenceWorkflow.components(separatedBy: "--approval-policy single-maintainer").count - 1, 2)
        ...
        XCTAssertTrue(publishWorkflow.contains("Require Single-Maintainer Publication Approval Environment"))
        XCTAssertEqual(publishWorkflow.components(separatedBy: "--approval-policy single-maintainer").count - 1, 2)
