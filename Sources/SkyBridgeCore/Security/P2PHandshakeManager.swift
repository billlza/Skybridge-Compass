...
/// Legacy handshake helper (pre-paper alignment).
///
/// ⚠️ Do not use in production code paths:
/// - Not the actor-isolated state machine from the paper
/// - No transcript binding / Finished frames
...
#else
@available(*, unavailable, message: "Legacy handshake is not available in Release builds. Use `HandshakeDriver` + `TwoAttemptHandshakeManager`.")
@MainActor
public final class P2PHandshakeManager {}
#endif
