// macOS-exclusive: 扫描实现依赖隔离属性 xattr、SecCode 代码签名校验与 Process。
// 模型类型见 Security/FileScanModels.swift（平台中立）。
#if os(macOS)
//
...
public actor FileScanService {
    ...
    // 源码兼容：既有调用点使用 `FileScanService.ScanLevel` /
    // `FileScanService.ScanConfiguration`；类型本身已抽到平台中立的 FileScanModels.swift。
    public typealias ScanLevel = FileScanLevel
    public typealias ScanConfiguration = FileScanConfiguration
