...
public struct DeviceDiscoveryView: View {
 ...
 // MARK: - 视图组件
    ...
    private var sortedDiscoveredDevices: [DiscoveredDevice] {
        // Put "my device" (local device) on top of the online list.
        service.discoveredDevices.sorted { a, b in
            if a.isLocalDevice != b.isLocalDevice { return a.isLocalDevice && !b.isLocalDevice }
