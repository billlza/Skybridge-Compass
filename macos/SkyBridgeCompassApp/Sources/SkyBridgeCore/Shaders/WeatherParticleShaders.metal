...
kernel void weather_particle_update(device WeatherParticle* particles [[buffer(0)]],
    ...
    // 计算风力
    float3 windForce = calculateWindForce(particle.position, weatherParams.windSpeed, weatherParams.windDirection, timeData.time);
...
/// 天气粒子顶点着色器
vertex VertexOut weather_particle_vertex(device WeatherParticle* particles [[buffer(0)]],
