...
fun RemoteDesktopScreen(
    ...
    val projectionLauncher = rememberLauncherForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
        remoteDesktopManager.handleProjectionResult(result.resultCode, result.data)
    }

    LaunchedEffect(remoteDesktopManager) {
        remoteDesktopManager.projectionRequests.collect {
            projectionLauncher.launch(remoteDesktopManager.createScreenCaptureIntent())
        }
    }
