...
- Target WinUI 3 + .NET 10 with `net10.0-windows10.0.22621.0`, TargetPlatformMinVersion `10.0.19041.0`, `WindowsPackageType=None` for unpackaged Windows App SDK auto-initialization, Windows App SDK `2.4.0`, Windows SDK BuildTools `10.0.28000.2705`, and QRCoder `1.8.0` for Windows QR bitmap rendering.
